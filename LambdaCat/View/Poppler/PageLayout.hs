module LambdaCat.View.Poppler.PageLayout
    ( DocumentGeometry
    , PageLayout
    , PageLayoutAlgorithm
...
import qualified Graphics.UI.Gtk.Poppler.View as PopplerPage
...
fromPageLayout
    ...
    -> IO [(PopplerDocument.View, Double, (Double, Double), (Double, Double))]
