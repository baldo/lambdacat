...
module LambdaCat.View.Poppler
    ( PopplerPage

    , popplerPage
    ) where

import qualified LambdaCat.View as View
import LambdaCat.View hiding (View)
import LambdaCat.View.Poppler.PageLayout
...
import Graphics.UI.Gtk.Poppler.View
import Network.URI
...
popplerPage :: View.View
popplerPage = View.View (undefined :: PopplerPage)
